...
public class RepairServiceTests extends DataCleaningTests {
	...
	@Test
	public void testSimulAnnealWeightedSim() throws Exception {
		for (float sim : Config.SIM_THRESHOLDS) {
			simThreshold = sim;
	...
	@Test
	public void testSimulAnnealEpsDynSim() throws Exception {
		for (float sim : Config.SIM_THRESHOLDS) {
			simThreshold = sim;
			logger.log(ProdLevel.PROD, "Books simThreshold : " + simThreshold);
			runProtocolEVS(SearchType.SA_EPS_DYNAMIC);
	...
	@Test
	public void testSimulAnnealEpsFlexiSim() throws Exception {
		for (float sim : Config.SIM_THRESHOLDS) {
			simThreshold = sim;
			logger.log(ProdLevel.PROD, "Books simThreshold : " + simThreshold);
			runProtocolEVS(SearchType.SA_EPS_FLEX);
	...
	@Test
	public void testSimulAnnealEpsLexSim() throws Exception {
		for (float sim : Config.SIM_THRESHOLDS) {
			simThreshold = sim;
			logger.log(ProdLevel.PROD, "Books simThreshold : " + simThreshold);
			runProtocolEVS(SearchType.SA_EPS_LEX);
