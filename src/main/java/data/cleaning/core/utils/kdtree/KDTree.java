...
public class KDTree<T> implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3485382302967703890L;
	 ...
	 */
	public void insert(float[] key, T value) throws KeySizeException,
	...
	public void edit(float[] key, Editor<T> editor) throws KeySizeException,
			KeyDuplicateException {
	...
	public void delete(float[] key) throws KeySizeException,
			KeyMissingException {
		delete(key, false);
	}
	 ...
	 */
	public void delete(float[] key, boolean optional) throws KeySizeException,
			KeyMissingException {
	 ...
	 *             if key.length mismatches K
	 */
	public List<T> nearest(float[] key, int n) throws KeySizeException,
	 ...
	 */
	public List<T> nearest(float[] key, int n, Checker<T> checker)
	...
	private NearestNeighborList<KDNode<T>> getnbrs(float[] key)
			throws KeySizeException {
		return getnbrs(key, m_count, null);
	}

	private NearestNeighborList<KDNode<T>> getnbrs(float[] key, int n,
	...
	public List<T> nearestDistance(float[] key, float dist) throws KeySizeException {
